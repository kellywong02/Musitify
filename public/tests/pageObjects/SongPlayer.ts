...
export class Musitify_SongPlayer{
  readonly page: Page;
  ...
  songCardByTitle(songTitle: string): Locator{
    ...
    get SongPlayerDuration(): Locator{
        return this.page.locator('#songDuration');
    }
    ...
    get UpcomingSongs(): Locator {
        return this.page.locator('#upcomingList .upcoming-song');
    }
    ...
    get UpcomingSongArea(): Locator{
        return this.page.locator('#upcomingList');
    }

    get SongLyricsCard(): Locator{
        return this.page.locator('.lyrics-card');
    }
    get LyricsContent(): Locator {
        return this.page.locator('#lyricsContent');
    }

    get LyricsCard(): Locator {
        return this.page.locator('.lyrics-card');
    }

    get UpcomingCard(): Locator {
        return this.page.locator('.upcoming-card');
    }

    get LyricLines(): Locator {
        return this.page.locator('#lyricsContent .lyric-line');
    }

  get ActiveLyricLine(): Locator {
    return this.page.locator('#lyricsContent .lyric-line.active');
  }
